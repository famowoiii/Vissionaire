@echo off
title ULTIMATE START - Full Auto System
color 0A
cls

echo ============================================================
echo   ULTIMATE START - FULLY AUTOMATED SYSTEM
...
echo   6. Open Visionnaire ready to use!
echo.
echo ============================================================
echo.

REM Check MySQL
echo [Step 1/13] Checking MySQL...
...
echo.
echo [Step 2/13] Clearing Redis cache...
...
REM Start Redis
echo.
echo [Step 3/13] Starting Redis Server...
redis-cli.exe ping >nul 2>&1
if errorlevel 1 (
...
echo.
echo [Step 4/13] Starting YOLO Detection API (8000)...
...
echo.
echo [Step 5/13] Starting Violation Records API (8002)...
...
echo.
echo [Step 6/13] Starting FCM Notification API (8003)...
...
REM Start Chat API
echo.
echo [Step 7/13] Starting Chat API (8004)...
...
echo.
echo [Step 8/13] Starting DB Management API (8005)...
...
echo.
echo [Step 9/13] Starting Streaming Web API (8800)...
...
echo.
echo [Step 10/13] Waiting for all services to initialize...
timeout /t 15 /nobreak >nul

REM Auto-generate config for ALL streams from database
echo.
echo [Step 11/13] Auto-generating config for ALL streams from database...
...
REM Verify services
echo.
echo [Step 12/13] Verifying services...
...
echo [Step 13/13] Creating Visionnaire auto-config instructions...
...
echo   4. Auto-config page opened
echo.
echo Next steps:
...
echo ============================================================
echo.
echo Active services: 8 terminal windows
echo   - Redis (6379)
...
echo   - Detection (ALL streams with Telegram)
echo.
